...
export const SyllabusHeader: React.FC<Props> = ({ subject, handlePrint }) => (
    <div className="flex items-center justify-between no-print glass-panel p-4 rounded-2xl">
        ...
        <div className="flex items-center gap-4">
            <button onClick={handlePrint} className="px-4 py-2 text-xs font-bold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl hover:bg-slate-50 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300 transition-colors flex items-center gap-2 shadow-sm">🖨️ Print View</button>
